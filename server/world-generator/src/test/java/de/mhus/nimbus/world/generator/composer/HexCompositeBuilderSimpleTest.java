...
public class HexCompositeBuilderSimpleTest extends HexCompositeBuilderAbstract {
    ...
    public void testSimpleRoad() throws Exception {
        ...
        var hexGridString = JsonMapper.builder()
                .disable(DeserializationFeature.FAIL_ON_NULL_FOR_PRIMITIVES)
                .build()
                .writeValueAsString(res.getWHexGrids());
    ...
    public void testTightPlacement() throws Exception {
        ...
        log.info(
                "Tight placement: {} biomes placed with {} retries",
                res.getTotalBiomes(),
                res.getBiomePlacementResult() != null
                        ? res.getBiomePlacementResult().getRetries()
                        : "N/A");
    }
    ...
    public void testMarshBiomeTidal() throws Exception {
        ...
        var hexGridString = JsonMapper.builder()
                ...
                .writeValueAsString(res.getWHexGrids());
        assertTrue(
                hexGridString.contains("g_builder\":\"swamp\""),
                "HexGrids should use swamp builder (marsh uses swamp builder)");
    }
    ...
    public void testGroundTypeSnowy() throws Exception {
        ...
        var hexGridString = JsonMapper.builder()
                ...
                .writeValueAsString(res.getWHexGrids());
        assertTrue(
                hexGridString.contains("snowMaterial") || hexGridString.contains("groundType"),
    ...
    public void testGroundTypeSandy() throws Exception {
        ...
        var hexGridString = JsonMapper.builder()
                ...
                .writeValueAsString(res.getWHexGrids());
        assertTrue(
                hexGridString.contains("desertSandMaterial") || hexGridString.contains("groundType"),
    ...
    public void testGroundTypeVolcanic() throws Exception {
        ...
        var hexGridString = JsonMapper.builder()
                ...
                .writeValueAsString(res.getWHexGrids());
        assertTrue(
                hexGridString.contains("bedrockMaterial") || hexGridString.contains("groundType"),
    ...
    public void testGroundTypeIcy() throws Exception {
        ...
        var hexGridString = JsonMapper.builder()
                ...
                .writeValueAsString(res.getWHexGrids());
        assertTrue(
                hexGridString.contains("iceMaterial") || hexGridString.contains("groundType"),
    ...
    public void testMountainBiomeSnowy() throws Exception {
        ...
        assertTrue(
                hexGridString.contains("groundType") || hexGridString.contains("snowMaterial"),
