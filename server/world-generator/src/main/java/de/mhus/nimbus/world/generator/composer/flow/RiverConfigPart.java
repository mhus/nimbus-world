...
public class RiverConfigPart {
     ...
     */
    public static RiverConfigPart createFromPart(
            EDGE side, Integer width, Integer depth, Integer level, String groupId) {
     ...
     */
    public static RiverConfigPart createToPart(EDGE side, Integer width, Integer depth, Integer level, String groupId) {
        return RiverConfigPart.builder()
     ...
     */
    public static RiverConfigPart createFromPositionPart(
            Integer lx, Integer lz, Integer width, Integer depth, Integer level, String groupId) {
        return RiverConfigPart.builder()
                .partType(PartType.FROM)
                .lx(lx)
                .lz(lz)
     ...
     */
    public static RiverConfigPart createToPositionPart(
            Integer lx, Integer lz, Integer width, Integer depth, Integer level, String groupId) {
        return RiverConfigPart.builder()
                .partType(PartType.TO)
                .lx(lx)
     ...
     */
    public static RiverConfigPart createFromPositionStringPart(
            String position, Integer width, Integer depth, Integer level, String groupId) {
        return RiverConfigPart.builder()
                .partType(PartType.FROM)
                .position(position)
                .width(width)
     ...
     */
    public static RiverConfigPart createToPositionStringPart(
            String position, Integer width, Integer depth, Integer level, String groupId) {
        return RiverConfigPart.builder()
                .partType(PartType.TO)
                .position(position)
