...
public class Day1WorldCreate extends MethodBasedWorkflow {
    ...
    public Map<String, Object> initialize(String worldIdDontUse, Map<String, String> params) throws WorkflowException {
        ...
        return Map.of(GenesisConst.WORLD_ID, worldId);
    }
    ...
    public void start(WorkflowContext context) throws WorkflowException {
        ...
        // create the world
        var worldId = WorldId.of((String) context.getParameters().get(GenesisConst.WORLD_ID))
                .orElseThrow();
        worldService.createWorld(
                ...
                WorldInfo.builder()
                        ...
                        .entryPoint(WorldInfoEntryPointDTO.builder()
        ...
        // create layers
        var groundLayer =
                layerService.createLayer(worldId.getId(), "ground", LayerType.GROUND, 100, true, List.of(), true);
        var floraLayer =
                layerService.createLayer(worldId.getId(), "flora", LayerType.GROUND, 10, true, List.of(), false);
        var structuresLayer =
                layerService.createLayer(worldId.getId(), "structures", LayerType.MODEL, 20, true, List.of(), false);

        context.addRecord(new ResultRecord(Map.of(
