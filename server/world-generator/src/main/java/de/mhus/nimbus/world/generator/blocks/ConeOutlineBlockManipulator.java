 ...
 * - radius: integer - Base radius (required)
 * - height: integer - Cone height (required)
...
@Component
@Slf4j
public class ConeOutlineBlockManipulator implements BlockManipulator {
