...
@Slf4j
public class Town extends Structure implements BuildFeature {
    private List<TownBuildingDefinition> buildings;
    private List<TownStreetDefinition> streets;
    ...
    public void configureHexGrids(List<HexVector2> coordinates, int hexGridSize) {
        ...
        for (DistrictGrid districtGrid : designResult.getDistrictGrids()) {
            ...
            TownGridConfig gridConfig = createGridConfig(districtGrid);
...
//    }
    ...
    public void connectExternalConnectionPoints(int hexGridSize) {
        ...
        for (TownConnectionPoint externalPoint : externalConnectionPoints) {
     ...
     */
    private void connectExternalPoint(TownConnectionPoint externalPoint, int hexGridSize) {
