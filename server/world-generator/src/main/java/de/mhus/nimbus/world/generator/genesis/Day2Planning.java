...
public class Day2Planning extends MethodBasedWorkflow {
    ...
    public void start(WorkflowContext context) throws WorkflowException {
        ...
        context.enqueueJob("generator-translate-instruction", "", Map.of(GenesisConst.INSTRUCTIONS_DOCUMENT_ID, (String)
                context.getParameters().get(GenesisConst.INSTRUCTIONS_DOCUMENT_ID)));
    }
    ...
    public void onTranslationInstructionSuccess(WorkflowContext context) throws WorkflowException {
        ...
        context.enqueueJob(
                "generator-apply-translated-instruction", "", Map.of("translationDocumentId", translationDocumentId));
    }
    ...
    public void onApplyInstructionSuccess(WorkflowContext context) throws WorkflowException {
        ...
        context.enqueueJob(
                "generator-fill-model-random-values",
                "",
                "",
                "Fill Flora/Fauna Values",
                Map.of("documentId", compositionDocumentId, "worldId", context.getWorldId()));
    }
    ...
    public void onFillModelRandomValuesSuccess(WorkflowContext context) throws WorkflowException {
        ...
        var enrichedDocumentId = context.getJobResultString("documentId")
                .orElseThrow(() -> new WorkflowException(
                        null, "FillModelWithRandomValues job result does not contain 'documentId'."));
        ...
        context.enqueueJob(
                "hex-grid-schema-image", "", "", "Create Schema Image", Map.of("compositionId", enrichedDocumentId));
    }

    /**
     * Update the composition document with epoch and parentEpoch values.
     */
    private void updateCompositionEpoch(
            WorldId wid, String collection, String documentId, int epoch, Integer parentEpoch)
