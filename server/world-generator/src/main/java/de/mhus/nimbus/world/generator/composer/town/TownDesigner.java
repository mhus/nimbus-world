...
public class TownDesigner {
     ...
     */
    private List<DistrictGrid> positionDistricts(Town village) {
     ...
     */
    private void arrangePlacesInDistrict(DistrictGrid districtGrid, Town village, int hexGridSize) {
     ...
     */
    private void assignBuildingsToPlaces(DistrictGrid districtGrid, Town village, int hexGridSize) {
     ...
     */
    private void drawStreets(List<DistrictGrid> districtGrids, Town village, int hexGridSize) {
     ...
     */
    private List<StreetSegment> convertHexPathToSegments(HexPath path, Town village, int hexGridSize) {
     ...
     */
    private void positionBuildings(DistrictGrid districtGrid, Town village, int hexGridSize) {
     ...
     */
    private void fillRemainingAreas(DistrictGrid districtGrid, Town village, int hexGridSize) {
