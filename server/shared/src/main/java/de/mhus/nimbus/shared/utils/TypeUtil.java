...
public class TypeUtil {
    ...
    public static Vector3Int vector3(int x, int y, int z) {
        return Vector3Int.builder().x(x).y(y).z(z).build();
    }
    ...
    public static Vector2 vector2(double x, double z) {
        return Vector2.builder().x(x).z(z).build();
    }
    ...
    public static Vector2Pair vector2Pair(Vector2 a, Vector2 b) {
        return Vector2Pair.builder().a(a).b(b).build();
    }

    public static Vector2Pair vector2Pair(double ax, double az, double bx, double bz) {
        return Vector2Pair.builder().a(vector2(ax, az)).b(vector2(bx, bz)).build();
    }

    public static Vector3Pair vector3Pair(Vector3 a, Vector3 b) {
        return Vector3Pair.builder().a(a).b(b).build();
    }
    ...
    public static Area parseArea(String s) {
        ...
        if (coord.contains(",")) {
            if (coord.split(",").length == 3) {
                ...
                return area(
                        (int) pos.getX(), (int) pos.getY(), (int) pos.getZ(), (int) sz.getX(), 255, (int) sz.getZ());
            } else {
            ...
            return Area.builder()
                    .position(vector3(h.getQ(), 0, h.getR()))
                    .size(vector3((int) sz.getX(), 255, (int) sz.getZ()))
                    .build();
        } else if (coord.contains("/")) {
            if (coord.split("/").length == 3) {
                ...
                return Area.builder()
                        .position(vector3((int) pos.getX(), 0, (int) pos.getZ()))
                        .size(vector3((int) sz.getX(), 255, (int) sz.getZ()))
                        .build();
            }
        } else {
    ...
    public static Vector2Int vector2int(int x, int z) {
        return Vector2Int.builder().x(x).z(z).build();
    }
