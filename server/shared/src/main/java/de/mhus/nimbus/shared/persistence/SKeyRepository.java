...
public interface SKeyRepository extends MongoRepository<SKey, String> {
    ...
    List<SKey> findAllByTypeAndKindAndOwnerAndIntentOrderByCreatedAtDesc(
            String type, String kind, String owner, String intent);
    ...
    Optional<SKey> findTop1ByTypeAndKindAndOwnerAndIntentOrderByCreatedAtDesc(
            String name, String kindPrivate, String owner, String intent);
