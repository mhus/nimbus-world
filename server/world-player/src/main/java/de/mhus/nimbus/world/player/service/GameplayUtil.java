...
public class GameplayUtil {
    ...
    public static final String SOUND_WINDOW_CLOSE =
            "n:audio/actions/window_close1.ogg,n:audio/actions/window_close2.ogg";
    ...
    public static final String SOUND_ITEM_COLLECT =
            "n:audio/actions/item_collect1.ogg,n:audio/actions/item_collect2.ogg";
    ...
    public static final String SOUND_ATTACK_BLOCKED =
            "n:audio/actions/attack_blocked1.ogg,n:audio/actions/attack_blocked2.ogg";
