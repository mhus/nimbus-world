    ...
    public ResponseEntity<?> findOrigin(
        ...
        try {
            ...
            if (origin == null) {
                ...
                return ResponseEntity.ok(Map.of("found", false, "message", "Block not found in any layer"));
            }
            ...
            log.info(
                    "Found block origin: worldId={}, pos=({},{},{}), layer={}",
                    lookupWorldId,
                    x,
                    y,
                    z,
            ...
            return ResponseEntity.ok(Map.of("found", true, "origin", dto));

        } catch (Exception e) {
            log.error("Failed to find block origin: worldId={}, pos=({},{},{})", lookupWorldId, x, y, z, e);
            return ResponseEntity.status(500).body(Map.of("error", "Failed to find block origin: " + e.getMessage()));
        }
    }
