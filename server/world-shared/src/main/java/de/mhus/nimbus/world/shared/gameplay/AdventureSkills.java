...
public final class AdventureSkills {
    ...
    public static final Skill COMBAT_MELEE = Skill.of(
            "combat_melee", "Nahkampf", "Verbessert Nahkampfschaden und Trefferchance", "Kampf", true, 100, 50, 500);

    public static final Skill COMBAT_RANGED = Skill.of(
            "combat_ranged", "Fernkampf", "Verbessert Fernkampfschaden und Praezision", "Kampf", true, 100, 50, 500);

    public static final Skill COMBAT_MAGIC = Skill.of(
            "combat_magic", "Magie", "Verbessert magischen Schaden und Trefferchance", "Kampf", true, 100, 50, 500);
    ...
    public static final Skill COMBAT_WEAPON_CARE = Skill.of(
            "combat_weaponCare", "Waffenpflege", "Reduziert den Verschleiss von Waffen", "Kampf", false, 100, 50, 500);
    ...
    public static final Skill SURVIVAL_VITALITY = Skill.of(
            "survival_vitality", "Vitalitaet", "Mehr Lebenspunkte und Regeneration", "Ueberleben", true, 1, 0, 100);

    public static final Skill SURVIVAL_ENDURANCE = Skill.of(
            "survival_endurance", "Ausdauer", "Mehr Ausdauer und schnellere Erholung", "Ueberleben", true, 1, 0, 100);

    public static final Skill SURVIVAL_WILLPOWER = Skill.of(
            "survival_willpower", "Willenskraft", "Mehr Mana und Mana-Regeneration", "Ueberleben", true, 1, 0, 100);
    ...
    public static final Skill SURVIVAL_ACROBATICS = Skill.of(
            "survival_acrobatics", "Akrobatik", "Erlaubt hoeheres Fallen ohne Schaden", "Ueberleben", true, 2, 2, 100);

    // --- Gathering Skills (multiplicative: 100 = normal speed, 200 = double speed) ---

    public static final Skill GATHERING_MINING = Skill.of(
            "gathering_mining", "Bergbau", "Schnelleres Abbauen von Steinen und Erzen", "Sammeln", true, 100, 50, 300);

    public static final Skill GATHERING_WOODWORK = Skill.of(
            "gathering_woodwork", "Holzarbeit", "Schnelleres Faellen von Baeumen", "Sammeln", true, 100, 50, 300);
    ...
    public static final Skill GATHERING_FISHING =
            Skill.of("gathering_fishing", "Angeln", "Bessere Faenge beim Angeln", "Sammeln", true, 100, 50, 300);
    ...
    public static final Skill UTILITY_BACKPACK = Skill.of(
            "utility_backpack", "Tragfaehigkeit", "Erlaubt das Tragen von mehr Items", "Sonstiges", false, 0, 0, 30);
