 ...
 *
 * @param id           Technical skill ID, e.g. "combat.melee"
...
public record BaseSkill(String id, String category, int defaultValue, double scaleFactor) {
    ...
    public static final BaseSkill COMBAT_MELEE = new BaseSkill("combat.melee", "combat", 100, 100.0);

    /** Combat ranged skill — affects ranged accuracy */
    public static final BaseSkill COMBAT_RANGED = new BaseSkill("combat.ranged", "combat", 100, 100.0);

    /** Combat magic skill — affects magical damage */
    public static final BaseSkill COMBAT_MAGIC = new BaseSkill("combat.magic", "combat", 100, 100.0);

    /** Combat defense skill — affects physical defense */
    public static final BaseSkill COMBAT_DEFENSE = new BaseSkill("combat.defense", "combat", 100, 100.0);

    /** Combat magic defense skill — affects magical defense */
    public static final BaseSkill COMBAT_MAGIC_DEFENSE = new BaseSkill("combat.magicDefense", "combat", 100, 100.0);
}
