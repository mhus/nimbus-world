...
class WorldRedisMessagingServiceTest {
    ...
    void publishAndSubscribe() {
        ...
        Mockito.verify(container)
                .addMessageListener(any(MessageListener.class), eq(ChannelTopic.of("world:r1:w1:::updates")));
        ...
        Mockito.verify(container)
                .removeMessageListener(any(MessageListener.class), eq(ChannelTopic.of("world:r1:w1:::updates")));
    }
}
