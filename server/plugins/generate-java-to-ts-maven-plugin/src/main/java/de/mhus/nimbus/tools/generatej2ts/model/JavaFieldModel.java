...
public class JavaFieldModel {
    ...
    public String getTsTypeOverride() {
        return tsTypeOverride;
    }

    public void setTsTypeOverride(String tsTypeOverride) {
        this.tsTypeOverride = tsTypeOverride;
    }
    ...
    public void setStaticFinal(boolean staticFinal) {
    ...
    public String getImportSymbol() {
        return importSymbol;
    }

    public void setImportSymbol(String importSymbol) {
    ...
    public String getInlineImportLine() {
        return inlineImportLine;
    }

    public void setInlineImportLine(String inlineImportLine) {
        this.inlineImportLine = inlineImportLine;
    }

    public String getImportOverride() {
        return importOverride;
    }

    public void setImportOverride(String importOverride) {
