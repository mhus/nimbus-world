...
public class JavaClassModel {
    ...
    public String getGenerateSubfolder() {
        return generateSubfolder;
    }

    public void setGenerateSubfolder(String generateSubfolder) {
        this.generateSubfolder = generateSubfolder;
    }
    ...
    public String getGenerateInterfaceName() {
        return generateInterfaceName;
    }

    public void setGenerateInterfaceName(String generateInterfaceName) {
        this.generateInterfaceName = generateInterfaceName;
    }
    ...
    public Set<String> getTypeScriptImports() {
        return typeScriptImports;
    }

    public List<JavaEnumModel> getInnerEnums() {
        return innerEnums;
    }
}
