      ...
      <div class="container mx-auto px-4 py-6">
        <div class="flex items-center justify-between">
          ...
          <div class="flex gap-2">
            <a href="/controls/login-forward.html" class="p-2 rounded bg-blue-700 hover:bg-blue-800 transition-colors" title="Login">
    ...
    <main v-else class="flex-1 container mx-auto px-4 py-8">
      <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        ...
        <EditorCard
          ...
          description="Manage universe connection and sector registration"
          url="/controls/universe-editor.html"
        >
          <svg class="w-8 h-8 text-indigo-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3.055 11H5a2 2 0 012 2v1a2 2 0 002 2 2 2 0 012 2v2.945M8 3.935V5.5A2.5 2.5 0 0010.5 8h.5a2 2 0 012 2 2 2 0 104 0 2 2 0 012-2h1.064M15 20.488V18a2 2 0 012-2h3.064M21 12a9 9 0 11-18 0 9 9 0 0118 0z" />
          </svg>
...
const editorRoleMap: Record<string, string[]> = {
  'REGION_EDITOR': ['SECTOR_ADMIN', 'REGION_MAINTAINER'],
  'USER_EDITOR': ['SECTOR_ADMIN'],
  'CHARACTER_EDITOR': ['SECTOR_ADMIN', 'REGION_MAINTAINER'],
  'WORLD_EDITOR': ['SECTOR_ADMIN', 'WORLD_OWNER', 'WORLD_EDITOR'],
  ...
  'TEAM_EDITOR': ['SECTOR_ADMIN', 'TEAM_EDITOR', 'WORLD_EDITOR'],
  'UNIVERSE_EDITOR': ['SECTOR_ADMIN'],
  ...
  'PROGRESS_EDITOR': ['SECTOR_ADMIN', 'PROGRESS_EDITOR', 'WORLD_EDITOR'],
};
